...
/*
Nota de funcionamiento de compareTo: 
Si el objeto actual es menor al del parametro, retorna < 0 (negativo)
Si el objeto actual es mayor al del parametro, retorna > 0 (positivo)
Si el objeto actual es igual al del parametro retorna 0 
*/
    ...
    public void hacerSubir(int posHijo){
        ...
        while (!flag){
            ...
            if (posPadre > 0){ //si existe el padre
                if (aux.compareTo(this.heap[posPadre]) < 0){ //si el hijo es menor al padre los intercambio
